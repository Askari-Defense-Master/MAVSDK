...
public:
    ...
    static std::unique_ptr<rpc::offboard::AttitudeQuaternion> translateToRpcAttitudeQuaternion(const mavsdk::Offboard::AttitudeQuaternion &attitude_quaternion)
    {
        auto rpc_obj = std::make_unique<rpc::offboard::AttitudeQuaternion>();


            
        rpc_obj->set_w(attitude_quaternion.w);
            
        
            
        rpc_obj->set_x(attitude_quaternion.x);
            
        
            
        rpc_obj->set_y(attitude_quaternion.y);
            
        
            
        rpc_obj->set_z(attitude_quaternion.z);
            
        
            
        rpc_obj->set_thrust_value(attitude_quaternion.thrust_value);
    ...
    static mavsdk::Offboard::AttitudeQuaternion translateFromRpcAttitudeQuaternion(const rpc::offboard::AttitudeQuaternion& attitude_quaternion)
    {
        mavsdk::Offboard::AttitudeQuaternion obj;


            
        obj.w = attitude_quaternion.w();
            
        
            
        obj.x = attitude_quaternion.x();
            
        
            
        obj.y = attitude_quaternion.y();
            
        
            
        obj.z = attitude_quaternion.z();
            
        
            
        obj.thrust_value = attitude_quaternion.thrust_value();
    ...
    grpc::Status SetAttitudeQuaternion(
        grpc::ServerContext* /* context */,
        const rpc::offboard::SetAttitudeQuaternionRequest* request,
        rpc::offboard::SetAttitudeQuaternionResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_attitude(translateFromRpcAttitudeQuaternion(request->attitude_quaternion()));
