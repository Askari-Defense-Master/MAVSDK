...
using AttitudeQuaternion = Offboard::AttitudeQuaternion;
...
Offboard::Result Offboard::set_attitude(AttitudeQuaternion attitude_quaternion) const
{
    return _impl->set_attitude(attitude_quaternion);
}
...
bool operator==(const Offboard::AttitudeQuaternion& lhs, const Offboard::AttitudeQuaternion& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, Offboard::AttitudeQuaternion const& attitude_quaternion)
{
    str << std::setprecision(15);
    str << "attitude_quaternion:" << '\n'
        << "{\n";
    str << "    w: " << attitude_quaternion.w << '\n';
    str << "    x: " << attitude_quaternion.x << '\n';
    str << "    y: " << attitude_quaternion.y << '\n';
    str << "    z: " << attitude_quaternion.z << '\n';
    str << "    thrust_value: " << attitude_quaternion.thrust_value << '\n';
    str << '}';
    return str;
}
